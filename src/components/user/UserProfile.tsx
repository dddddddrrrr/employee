...
import { toggleSettingDialogAtom } from "~/app/atoms/settingsAtoms";
...
const UserProfile = () => {
  ...
  const [isSettingOpen, toggleSettingDialog] = useAtom(toggleSettingDialogAtom);
    ...
    <>
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        ...
        >
          <div
            onClick={() => {
              router.push(`/center/${session?.user.id}`);
            }}
      ...
      <SettingDialog
        ...
        setIsSettingOpen={toggleSettingDialog}
      />
    </>
  );
};
